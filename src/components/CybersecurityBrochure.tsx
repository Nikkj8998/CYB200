...
export interface CybersecurityBrochureRef {
  goToPage: (pageIndex: number) => void;
}

export const CybersecurityBrochure = forwardRef<CybersecurityBrochureRef, { initialPage?: number }>(
  ({ initialPage }, ref) => {
    ...
    const pages = [
      {
        isTitle: true,
        title: "Cybersecurity",
        description: "Your Complete Defense Partner",
      },
      {
        title: "VAPT Assessment",
        description:
          "Comprehensive vulnerability and penetration testing services",
        features: [
      ...
      },
      {
        ...
        stats: { value: "24/7", label: "Protection Active" },
      },
      {
        title: "Firewall & IDS/IPS",
        description:
          "Next-generation firewall solutions with intrusion detection",
        features: [
        ...
        stats: { value: "100%", label: "Threat Blocked" },
      },
      {
        title: "Email Security",
        description:
          "Advanced email protection with anti-phishing and malware filtering",
        features: [
        ...
        stats: { value: "98%", label: "Phishing Blocked" },
      },
      {
        title: "Encryption & Backup",
        description:
          "Military-grade encryption with secure backup and disaster recovery",
        features: [
          "AES-256 encryption",
        ...
        stats: { value: "<1hr", label: "Recovery Time" },
      },
      {
        title: "SIEM & SOC Monitoring",
        description:
          "Centralized security monitoring with 24/7 threat response",
        features: [
        ...
        stats: { value: "24/7", label: "Monitoring Active" },
      },
      {
        title: "Threat Hunting",
        description:
          "Proactive threat hunting combined with rapid incident response",
        features: [
      ...
      },
      {
        ...
        description:
          "Comprehensive compliance support for ISO, GDPR, HIPAA and more",
        features: [
          "Gap assessments",
          "Policy development",
          "Audit preparation",
        ...
        stats: { value: "10+", label: "Standards Covered" },
      },
      {
        title: "Security Awareness",
        description:
          "Employee training programs to strengthen security culture",
        features: [
        ...
        stats: { value: "85%", label: "Training Success" },
      },
    ];
    ...
    const [currentSpread, setCurrentSpread] = useState(() => {
      if (initialPage !== undefined && initialPage >= 0 && initialPage < 10) {
    ...
    return (
      <div className="w-full max-w-6xl mx-auto">
        ...
        <div className="book-container">
          ...
          <div className="hidden md:block relative w-full max-w-5xl mx-auto" style={{ aspectRatio: "2/1", maxHeight: "480px" }}>
            <div className="relative w-full h-full book">
              ...
              <div className="absolute left-1/2 -translate-x-1/2 w-2 h-full book-spine" style={{ zIndex: 5 }} />

              <div
                className={`page absolute left-1/2 w-1/2 h-full ${isFlipping ? "flipping" : ""}`}
                style={{ transformOrigin: "left center", zIndex: isFlipping ? 10 : 2 }}
              >
...
CybersecurityBrochure.displayName = "CybersecurityBrochure";
